...
solution_data <- data.frame(Depression34 = c(NA, seq(from = 0, to = 4, by = .5)),
                            Anxiety34 = c(NA, seq(from = 0, to = 4, by = .5)),
                            Social_Anxiety34 = c(NA, seq(from = 0, to = 4, by = .5)),
                            Academics34 = c(NA, seq(from = 0, to = 4, by = .5)),
                            Eating34 = c(NA, seq(from = 0, to = 4, by = .5)),
...
solution_data_first <- data.frame(Depression34_first = c(NA, seq(from = 0, to = 4, by = .5)),
...
test_that("CCAPS34 cuts", {
  expect_equal(ccaps34_cuts(test_data), solution_data)
})

test_that("CCAPS34_first cuts", {
  expect_equal(ccaps34_cuts(test_data_first), solution_data_first)
})
