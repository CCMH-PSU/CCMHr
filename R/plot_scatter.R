...
#' @name plot_scatter
#'
#' @description This function creates a scatter plot graph.
#'
...
#' @param plot.units A quoted string to indicate the plot's width and height size units. Options include `in`, `cm`, `mm`, and `px`. By default, `in`.
...
#' @param fit.line A logical argument to indicate whether the plot should have a fitted line. If `TRUE`, a fit line will be added to the plot. By default, `FALSE`.
...
#' @param fit.line.ci A logical argument to indicate whether the plotted fit line should display confidence intervals. If `TRUE`, confidence intervals will be displayed. By default, `FALSE`.
