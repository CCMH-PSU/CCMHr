...
#' @rdname CCMH_palettes
#' @format ## `CCMH_gradient_palettes`
#' An object of class `palettes_palette` with
#' `r length(CCMH_gradient_palettes)` sequential colour palettes.
#'  Use `names(CCMH_gradient_palettes)` to return all palette names.
"CCMH_gradient_palettes"

#' @rdname CCMH_palettes
#' @format ## `CCMH_diverging_palettes`
#' An object of class `palettes_palette` with
#' `r length(CCMH_diverging_palettes)` sequential colour palettes.
#'  Use `names(CCMH_diverging_palettes)` to return all palette names.
