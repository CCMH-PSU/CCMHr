...
create_CCAPS_bins <- function(data){
  ...
  # Conduct cuts
  data <- data |>
    dplyr::mutate(depression_bin = cut_mod(Depression34_first,
                                           breaks = c(0.00, 0.16,
                                                      0.33, 0.40,
                                                      0.60, 0.80,
                                                      1.00, 1.16,
                                                      ...
                                                      3.33, 3.50,
                                                      3.60, 4.00)),
                  anxiety_bin = cut_mod(Anxiety34_first,
                                        breaks = c(0.00, 0.16,
                                                   0.33, 0.50,
                                                   0.60, 0.80,
                                                   1.00, 1.16,
                                                   ...
                                                   3.60, 3.80,
                                                   4.00, 4.10)),
                  social_anxiety_bin = cut_mod(Social_Anxiety34_first,
                                               breaks = c(0.00, 0.20,
                                                          0.33, 0.60,
                                                          0.75, 1.00,
                                                          1.20, 1.33,
                                                          ...
                                                          3.60, 3.75,
                                                          4.00, 4.10)),
                  academics_bin = cut_mod(Academics34_first,
                                          breaks = c(0.00, 0.25,
                                                     0.50, 0.66,
                                                     1.00, 1.25,
                                                     1.50, 1.66,
                                                     ...
                                                     3.50, 3.66,
                                                     4.00, 4.10)),
                  eating_bin = cut_mod(Eating34_first,
                                       breaks = c(0.00, 0.33,
                                                  0.66, 1.00,
                                                  1.33, 1.66,
                                                  2.00, 2.33,
                                                  ...
                                                  3.33, 3.66,
                                                  4.00, 4.10)),
                  hostility_bin = cut_mod(Hostility34_first,
                                          breaks = c(0.00, 0.16,
                                                     0.33, 0.50,
                                                     0.60, 0.75,
                                                     1.00, 1.16,
                                                     ...
                                                     2.60, 2.75,
                                                     4.00)),
                  alcohol_bin = cut_mod(Alcohol34_first,
                                        breaks = c(0.00, 0.25,
                                                   0.50, 0.66,
                                                   1.00, 1.25,
                                                   1.50, 1.66,
