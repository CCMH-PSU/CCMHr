...
score_CCAPS <- function(data, CCAPS62 = T) {
  ...
  return(data)
    ...
    if(!all(c("CCAPS_03", "CCAPS_05", "CCAPS_06", "CCAPS_11", "CCAPS_13", "CCAPS_16", "CCAPS_17", "CCAPS_18", "CCAPS_21", "CCAPS_22", "CCAPS_24", "CCAPS_27", "CCAPS_29", "CCAPS_30", "CCAPS_31", "CCAPS_33", "CCAPS_34", "CCAPS_36", "CCAPS_39", "CCAPS_40", "CCAPS_45", "CCAPS_46", "CCAPS_48", "CCAPS_49", "CCAPS_51", "CCAPS_52", "CCAPS_54", "CCAPS_57", "CCAPS_58", "CCAPS_59", "CCAPS_63", "CCAPS_64", "CCAPS_66", "CCAPS_68") %in% colnames(data))) stop('CCAPS items not present in dataa or not properly named. CCAPS items should be named CCAPS_01 through CCAPS_70.')
