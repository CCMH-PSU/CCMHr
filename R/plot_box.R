...
#' @param color A hex code or list of hex codes that indicates the color of the grouped boxes. See Note 1 for more details. By default, `c('#E6AB02', '#1B9E77', '#666666', '#D95F02', '#6db6ff', '#b66dff', '#ff6db6', '#920000')`.
