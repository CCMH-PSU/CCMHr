...
#' @param old_names A vector of strings indicating the old (or expected) variable names in the data set. If `NULL`, a vector of variable names coming from the 2016-2017 combined data, stored as an Rdata file in the package, called "CCMHvars". By default, `NULL`.
#'
